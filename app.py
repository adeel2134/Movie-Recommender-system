...
def load_model():
    ...
    movies = pd.read_csv('https://huggingface.co/datasets/adeel10/tmdb-movies/resolve/main/tmdb_5000_movies.csv')
    credits = pd.read_csv('https://huggingface.co/datasets/adeel10/tmdb-movies/resolve/main/tmdb_5000_credits.csv')
